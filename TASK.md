...
| ~~P0-6~~ | ~~result 페이지 fold 검증~~ | ~~완료~~ | — | — | Dev | ✅ 완료 (`커밋 52c191b`) — isSharedLanding 시 ScoreGauge 직후로 NudgeCTA 이동, fold 안 노출 확인 |
...
- [x] **완료:** result 페이지 공유 랜딩 NudgeCTA fold 안으로 이동 (`커밋 52c191b`)
