    ...
    <div className="flex flex-col items-center gap-6 py-4">
      ...
      <div className="w-full rounded-3xl bg-gradient-to-br from-[#fff0f3] via-white to-[#f0f4ff] px-6 py-8 flex flex-col items-center gap-5 border border-[#F0E0E4]">
        ...
        <div className="flex gap-4 text-xs text-[#555555]">
          <span className="flex items-center gap-1"><span className="text-[#C00037]">✓</span> 쿠팡 후기 분석</span>
          <span className="flex items-center gap-1"><span className="text-[#C00037]">✓</span> 광고 없는 추천</span>
          <span className="flex items-center gap-1"><span className="text-[#C00037]">✓</span> 무료 이용</span>
        </div>
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-[11px] text-[#666666] bg-white border border-[#E9ECEF] rounded-full px-2 py-0.5">{emoji} {tagline}</span>
              </div>
              <p className="text-[#555555] text-sm leading-relaxed">{desc}</p>
              <p className="text-xs font-semibold mt-2 text-[#C00037] group-hover:underline">{ctaLabel} →</p>
            </div>
          </Link>
        ))}
      </div>
