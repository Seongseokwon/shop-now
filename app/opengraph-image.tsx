...
export default function OgImage() {
  return new ImageResponse(
    ...
    >
      ...
      {/* 본문 */}
      <div
        style={{ display: "flex", flex: 1, padding: "48px 72px", gap: "64px" }}
      >
        {/* 왼쪽: 브랜드 + 헤드라인 */}
        <div
          style={{
        ...
        >
          ...
          >
            ...
            <span
              style={{ fontSize: "18px", color: "#555555", lineHeight: 1.5 }}
            >
              광고 말고 진짜 괜찮은 상품만 추천
            </span>
          </div>
      ...
      >
        <span
          style={{ fontSize: "18px", color: "#999999", letterSpacing: "0.5px" }}
        >
